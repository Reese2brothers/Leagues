...
class ChampOverallAdapter(private val contextA : Context, private val listTable: List<RowXX>,
                          private val callback: ChampionshipOverallFragment
) : RecyclerView.Adapter<ChampOverallAdapter.ViewHolder>() {
