...
class OneOverallAdapter(private val contextA : Context, private val listTable: List<RowXX>,
                        private val callback: OneOverallFragment
) : RecyclerView.Adapter<OneOverallAdapter.ViewHolder>() {
