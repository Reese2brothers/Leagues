...
import com.tirokes.leagues.models.apl.table.RowX

class PremierHomeAdapter(private val contextA : Context, private val listTable: List<RowX>
) : RecyclerView.Adapter<PremierHomeAdapter.ViewHolder>() {
