...
import com.tirokes.leagues.models.leagueone.table.RowX

class OneHomeAdapter (private val contextA : Context, private val listTable: List<RowX>
) : RecyclerView.Adapter<OneHomeAdapter.ViewHolder>() {
