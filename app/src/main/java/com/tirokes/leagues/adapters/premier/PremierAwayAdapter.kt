...
import com.tirokes.leagues.models.apl.table.Table

class PremierAwayAdapter(private val contextA : Context, private val listTable: List<Row>
) : RecyclerView.Adapter<PremierAwayAdapter.ViewHolder>() {
