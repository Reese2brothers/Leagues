...
import com.tirokes.leagues.models.championship.table.RowX

class ChampHomeAdapter(private val contextA : Context, private val listTable: List<RowX>
) : RecyclerView.Adapter<ChampHomeAdapter.ViewHolder>() {
