...
import com.tirokes.leagues.models.championship.games.GamesPre
import java.text.SimpleDateFormat
import java.util.Date
import java.util.TimeZone

class ChampFutureAdapter(private val contextA: Context,
                         private val listTable: List<GamesPre>
) : RecyclerView.Adapter<ChampFutureAdapter.ViewHolder>() {
