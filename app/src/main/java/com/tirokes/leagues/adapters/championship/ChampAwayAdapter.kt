...
import com.tirokes.leagues.models.championship.table.Row

class ChampAwayAdapter(private val contextA : Context, private val listTable: List<Row>
) : RecyclerView.Adapter<ChampAwayAdapter.ViewHolder>() {
